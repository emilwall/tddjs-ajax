...
tddjs.isLocal = (function () {
  function isLocal(location) {
    ...
    return !!location && location.protocol.indexOf("file:") === 0;
  }
...
(function () {
  ...
  function myEncodeURI(urlParams) {
    if (!urlParams) {
      return "";
    }
    ...
    tddjs.each(urlParams, function (prop, val) {
  ...
  tddjs.namespace("encoding").myEncodeURI = myEncodeURI;
}());
